...
PROJECT_REPO := github.com/kirubaCathrin/provider-git
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Git CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Git controllers
...
# This target prepares repo for your provider by replacing all "git"
