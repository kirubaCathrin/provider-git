...
import (
	...
	"github.com/kirubaCathrin/provider-git/apis/repository/v1alpha1"
	
	apisv1alpha1 "github.com/kirubaCathrin/provider-git/apis/v1alpha1"
	"github.com/kirubaCathrin/provider-git/internal/controller/features"
)
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(&connector{
			...
			newGitClientFn: clients.NewRepositoryClient}),
...
type connector struct {
	kube         client.Client
	//added code below
	//newRepositoryClient      //add signature of a function for the provider api
	usage        resource.Tracker
	//newGitClientFn func(creds []byte) (interface{}, error)
	newGitClientFn func(clients.Config) git.KeyClientAPI
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	svc := c.newGitClientFn(clients.Config{
