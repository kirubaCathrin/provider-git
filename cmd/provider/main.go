...
import (
	...
	"github.com/kirubaCathrin/provider-git/apis/v1alpha1"
	git "github.com/kirubaCathrin/provider-git/internal/controller"
	"github.com/kirubaCathrin/provider-git/internal/controller/features"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Git support for Crossplane.").DefaultEnvars()
