...
The [provider-git](https://github.com/kirubaCathrin/provider-git) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-git](https://github.com/crossplane-contrib/provider-jet-git) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/kirubaCathrin/provider-git/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/kirubaCathrin/provider-git/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/kirubaCathrin/provider-git/blob/main/hack/boilerplate.go.txt](https://github.com/kirubaCathrin/provider-git/blob/main/hack/boilerplate.go.txt)
...
The [provider-git](https://github.com/kirubaCathrin/provider-git)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/kirubaCathrin/provider-git/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/kirubaCathrin/provider-git/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue gits (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/kirubaCathrin/provider-git/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Gits: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/kirubaCathrin/provider-git/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
